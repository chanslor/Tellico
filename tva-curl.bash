...
LINE1:ave \
LINE1:A#000000:CFS \
DEF:tmax=tempC3.rrd:CFS:MAX \
DEF:tmin=tempC3.rrd:CFS:MIN \
'GPRINT:ave:LAST:Last\: %2.1lf cfs' \
'GPRINT:tmin:MIN:Minimum\: %2.1lf cfs' \
'GPRINT:tmax:MAX:Maximum\: %2.1lf cfs\j'
